...
// Declare the namespace for the FlameSparkParticleState class
namespace JetBoxer2D.Game.Particles
{
    // Define the FlameSparkParticleState class inheriting from EmitterParticleState
    public class FlameSparkParticleState : EmitterParticleState
    {
        // Define properties for particle state
